...
const getPgStatActivity = (req,res)=> getData(req,res,`SELECT pid,usesysid,application_name,client_addr, client_port,state,query FROM pg_stat_activity where datname = 'mateusz'`)
